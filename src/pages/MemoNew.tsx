    ...
    <MainLayout showSidebar={false}>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          <Input value={title} onChange={e => setTitle(e.target.value)} placeholder="メモのタイトル" className="text-xl font-semibold h-12" />
          ...
          <div className="space-y-2">
            <Label>最初のエントリ</Label>
            <TiptapEditor content={firstEntry} onChange={setFirstEntry} placeholder="調査メモ、作業ログなどを記入..." />
          </div>
