...
insert into knowledge_share_hub.reactions (id, user_id, content_type, content_id, reaction_type, created_at) values
  ...
  ('90000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000001', 'tip', '20000000-0000-4000-8000-000000000002', 'learned', now()),
  ('90000000-0000-4000-8000-000000000004', '10000000-0000-4000-8000-000000000003', 'tip', '20000000-0000-4000-8000-000000000002', 'nice', now()),
  ('90000000-0000-4000-8000-000000000005', '10000000-0000-4000-8000-000000000001', 'tip', '20000000-0000-4000-8000-000000000003', 'helped', now()),
  ('90000000-0000-4000-8000-000000000006', '10000000-0000-4000-8000-000000000003', 'comment', '60000000-0000-4000-8000-000000000001', 'nice', now());
...
insert into knowledge_share_hub.notifications (id, user_id, type, content_type, content_id, actor_id, is_read, message, created_at) values
  ('80000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', 'reaction', 'tip', '20000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000002', false, '鈴木花子さんがあなたの気づきにリアクション「🙏 助かった」しました', '2026-04-03T11:00:00Z'),
  ...
  ('80000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000001', 'reaction', 'tip', '20000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000003', true, '山田一郎さんがあなたの気づきにリアクション「💡 勉強になった」しました', '2026-04-03T09:30:00Z');
