...
-- Step 8: Add try_it seed data for testing (only if seed users/content exist)
...
where exists (select 1 from knowledge_share_hub.profiles where id = '10000000-0000-4000-8000-000000000002')
  and exists (select 1 from knowledge_share_hub.tips where id = '20000000-0000-4000-8000-000000000003')
...
where exists (select 1 from knowledge_share_hub.profiles where id = '10000000-0000-4000-8000-000000000003')
  and exists (select 1 from knowledge_share_hub.profiles where id = '10000000-0000-4000-8000-000000000002')
on conflict do nothing;
